...
import '../../Admin/screen/notifications/admin_sent_notifications_screen.dart';

/// شاشة إرسال الإشعارات المخصصة للمنسق (مطابقة للإدارة)
class CoordinatorSendNotificationScreen extends StatefulWidget {
  const CoordinatorSendNotificationScreen({super.key});

  @override
  State<CoordinatorSendNotificationScreen> createState() => _CoordinatorSendNotificationScreenState();
}

class _CoordinatorSendNotificationScreenState extends State<CoordinatorSendNotificationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('new_notification'.tr, style: const TextStyle(fontFamily: 'Cairo', fontWeight: FontWeight.bold)),
        centerTitle: true,
        elevation: 0,
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // زر الإشعارات السابقة (ينقل لشاشة السجل)
            GestureDetector(
              onTap: () => Get.to(() => const AdminSentNotificationsScreen()),
              child: Container(
                width: double.infinity,
                ...
                child: Row(
                  children: [
                    ...
                    Icon(Icons.arrow_forward_ios_rounded, size: 18, color: isDark ? Colors.grey[400] : const Color(0xFF4F46E5)),
                  ],
                ),
              ),
            ),
