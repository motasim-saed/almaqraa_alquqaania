...
/// شاشة عرض الإشعارات الإدارية للمعلم بتصميم الدردشة
class TeacherNotificationsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('teacher_notifications'.tr, style: const TextStyle(fontFamily: 'Cairo', fontWeight: FontWeight.bold)),
      ...
      body: Obx(() {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return Align(
              alignment: Alignment.centerLeft, // الإشعارات تأتي من الإدارة (مثل الرسائل المستلمة)
              child: Container(
                    ...
                    children: [
                      Text(
                        ...
                        style: TextStyle(
                          ...
                          color: isDarkMode ? Colors.blue[300] : const Color(0xFF4F46E5),
                          fontSize: 14,
                          fontFamily: 'Cairo',
                        ),
                      ),
